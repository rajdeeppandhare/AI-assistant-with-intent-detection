...
def wishMe():
    ...
    if(hour>=0) and (hour<=12) and ('AM' in t):
        ...
        print(f"Good morning sir, it's {day} and the time is {t}")
    elif(hour>=12)  and (hour<=16) and ('PM' in t):
        speak(f"Good afternoon sir, it's {day} and the time is {t}")
        print(f"Good afternoon sir, it's {day} and the time is {t}")
    else:
        speak(f"Good evening sir, it's {day} and the time is {t}")
        print(f"Good evening sir, it's {day} and the time is {t}")
...
def condition():
    ...
    if percentage>=80:
        speak("Boss we could have enough charging to continue our project")
...
if __name__ == "__main__":
    wishMe()
    # engine_talk("Allow me to introduce myself I am ARGUS, the virtual artificial intelligence and I'm here to assist you with a variety of tasks as best I can, 24 hours a day seven days a week.")
    while True:
        query = command().lower()
